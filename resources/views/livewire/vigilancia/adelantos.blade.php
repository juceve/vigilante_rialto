<div class="container-fluid px-3 py-2" style="margin-top: 110px;">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="flex-shrink-0 me-3">
                    ...
                    ' .
                            ...
                            '&background=0D6EFD&color=fff&rounded=true&size=128';
                ...
                <div class="flex-grow-1">
                    <h5 class="mb-0 text-primary">{{ $empleado->nombres ?? 'Nombre' }}
                        {{ $empleado->apellidos ?? 'Apellidos' }}</h5>
                    <small
                        class="text-blue d-block mb-2"><strong>{{ $empleado->area->nombre ?? 'Cargo / Puesto' }}</strong></small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body d-grid">
            ...
            <div class="row mb-2">
                <div class="col-6">
                    <select class="form-select form-select-sm" wire:model="selMes">
                ...
                <div class="col-6">
                    <select class="form-select form-select-sm" wire:model="selGestion">
                        <option value="">Seleccione Gestion</option>
                        @foreach ($gestionesAdelantos as $gestion)
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 mb-2">
                                ...
                                <input type="number" id="monto" class="form-control" wire:model.lazy="monto"
                                    step="any" placeholder="Ingrese el monto">
                            </div>
                            <div class="col-12 col-md-6 mb-2">
                            ...
                            <div class="col-12 col-md-6 mb-2">
                                <small class="text-muted"><strong>Adjuntar <i
                                            class="fas fa-paperclip"></i></strong></small>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                            wire:loading.attr="disabled" wire:target="file,store"><i class="fas fa-ban"></i>
                            Cerrar</button>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body p-2 text-center">
                        <img id="modalDocPreviewImg" src="#" alt="Documento" class="img-fluid"
                ...
                return await new Promise((resolve, reject) => {
                    ...
                    reader.onload = () => {
                        ...
                        img.onload = () => {
                            ...
                            let quality = 0.92;
                            const mime = file.type === 'image/png' ? 'image/jpeg' : file
                                .type; // for PNG prefer JPEG for compression
