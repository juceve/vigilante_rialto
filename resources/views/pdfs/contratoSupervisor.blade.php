    ...
    <main>
        <div class="container">
            ...
            <p>
                ...
                27 de marzo de 2007, se encuentra suscrito en base a los contratos suscritos entre la empresa "RIALTO
                PATROL" de seguridad y vigilancia y las diferentes empresas donde RIALTO PATROL presta servicios.
            </p>
            <p>
                <strong>TERCERA. - (Duración del Contrato)</strong><br>
                El presente Contrato de Trabajo a Conclusión de Servicio se inicia el
                {{ fechaEs($contrato->fecha_inicio) }} y finaliza el {{ fechaEs($contrato->fecha_final) }}, pero queda
                establecido que la duración por dicho periodo se encuentra sujeto a la vigencia de los contratos
                principales, de acuerdo con los contratos principales que se señalan en el punto 2.2 de la cláusula
                segunda, en este caso las funciones principales a ejecutarse se realizaran en todos los clientes que
                tiene la empresa. Queda establecido que el presente contrato se encuentra sujeto al periodo de prueba
                establecido por ley.
            </p>
            <p>
                <strong>CUARTA.- (Cargo Laboral)</strong><br>
                El TRABAJADOR desempeñará las funciones propias de SUPERVISOR O ENCARGADO OPERATIVO, en la empresa
                mencionada en la Cláusula Segunda, de acuerdo a las instrucciones que al efecto sean impartidas por el
                EMPLEADOR, se establece que por razones extraordinarias o causas ajenas al EMPLEADOR este podrá
                modificar las funciones y/o tareas que sean asignadas al TRABAJADOR sin que esta medida signifique
                retiro indirecto, ni pueda dar lugar a reclamo ulteriores.
            </p>
            <p>
                ...
                el TRABAJADOR, en su calidad de SUPERVISOR O ENCARGADO OPERATIVO con respecto al movimiento del
                personal, uso de los equipos de seguridad y cuidado, al igual queda totalmente prohibido efectuar
                cualquier tipo de comentario que involucre al personal ejecutivo, empleados y/o dependientes tanto de
                cualquiera de nuestros clientes como también de la empresa a la presta servicio en este caso RIALTO
                PATROL SRL , <strong>el incurrir en esta falta, será catalogada como muy grave</strong>, misma que dará
                lugar a sanciones penales y civiles vigentes.
            </p>

            <p>
                <strong>SEXTA.- (Funciones Laborales)</strong> <br>
                El TRABAJADOR, tiene como principales funciones laborales las siguientes: <br>
                <strong>6.1</strong> Conocer y cumplir estrictamente los manuales de funciones, procedimientos, así como
                todas las normas y disposiciones relacionadas con la organización y funcionamiento de LA EMPRESA. <br>
                <strong>6.2</strong> Guardar y observar obediencia, disciplina y lealtad para con LA EMPRESA en sus
                dependencias y fuera de ellas. <br>
                <strong>6.3</strong> Asistir puntualmente al trabajo ajustándose al horario establecido salvo
                circunstancias de fuerza mayor debidamente justificadas. <br>
                <strong>6.4</strong> Efectuar con responsabilidad, eficiencia, honradez, diligencia y celeridad, el
                trabajo inherente a su cargo o cualquier otro que sea encomendado por sus superiores. <br>
                <strong>6.5</strong> Hacer uso adecuado de los equipos de comunicación, instrumentos, linternas, ponchos
                de agua, vehículos motorizados como ser: motos y vehículos etc…, que se les confía observando
                rigurosamente las normas, medidas y precauciones de seguridad para su manejo, responsabilizándose por
                todo deterioration, destrucción o perdida que se ocasionen en dichos instrumentos, si después de las
                investigaciones pertinentes resultaren culpables. <br>
                <strong>6.6</strong> Cumplir estrictamente las normas de higiene y seguridad industrial establecidas,
                precautelando su vida, salud e integridad física. <br>
                <strong>6.7</strong> Observar una conducta y/o comportamiento dentro de la moral, las buenas costumbres
                y respetuosas para sus superiores y compañeros de trabajo <br>
                <strong>6.8</strong> Dispensar a las autoridades, clientes y otros dando excelente atención, respeto,
                cortesía y amabilidad. <br>
                <strong>6.9</strong> Velar por la seguridad y comodidad de los señores clientes guardando compostura y
                respeto con ellos, atendiendo sus requerimientos con prontitud, amabilidad, gentileza y diligencia,
                evitando demoras , preservando el buen nombre de LA EMPRESA. <br>
                <strong>6.10</strong> Patrullar por todos los predios de la donde la empresa preste servicios según el
                cronograma respetando los tiempos e intervalos ya planificados, colaborar y ayudar al personal de
                seguridad para una eficiente labor dentro de los predios a custodiar, además de atender las necesidad y
                urgencias que pueden emerger. <br>
                <strong>6.11</strong> Observar y cumplir estrictamente los horarios, roles, turnos de trabajo
                establecidos por LA EMPRESA, conforme a las necesidades de ésta. <br>
                <strong>6.12</strong> Cumplir las instrucciones emanadas del personal ejecutivo o el personal autorizado
                para ello. <br>
                <strong>6.13</strong> No abandonar su puesto de trabajo sin que sus reemplazantes hayan llegado en caso
                de que tuvieran que cubrir algún permiso, libre o falta del personal de seguridad. <br>
                <strong>6.14</strong> Guardar absoluta reserva sobre cualquier información relacionada a los sistemas de
                trabajo, administración y organización de la EMPRESA, y en general a su documentación y archivos muy
                especialmente estará obligado a NO DIVULGAR secretos relativos a la seguridad de LA EMPRESA, los cuales
                le hubieran sido confiados en razón de su cargo en la misma como códigos de activación de alarmas o
                sistemas de seguridad, de archivos, contabilidad, etc. <br>
                <strong>6.15</strong> En caso de solicitar retiro voluntario deberá de hacerlo por escrito con al menos
                30 días de anticipación. <br>
                <strong>6.16</strong> El TRABAJADOR se compromete a mantener una presencia impecable referente a la
                limpieza personal, corte de cabello, uso de uniformes, mantenimiento y cuidado de equipos los cuales se
                les dotara para el cumplimiento_de sus funciones como ser: teléfono corporativo, motocicleta o vehículo,
                equipo EPP de protección etc.
            ...
            <p>
                ...
                General del Trabajo y de acuerdo con el contrato con el cliente al que prestamos servicios será bajo el
                siguiente horario de 7:00 am a 19:00 pm o de 19:00 pm a 7:00 am u horario bajo acuerdo de partes o
                horarios establecidos de acuerdo a requerimiento.

            </p>
            <p>
                <strong>OCTAVA. - (Remuneración)</strong> <br>
                El EMPLEADOR pagará al TRABAJADOR la suma de Bs.-
                {{ $contrato->salario_basico }} <strong>({{ numeroALetras($contrato->salario_basico) }})</strong>, en
                forma mensual, monto del cual se efectuarán los correspondientes descuentos de ley en los que el
                EMPLEADOR actúa en calidad de Agente de Retención ante la GESTORA PUBLICA.
            </p>
            <p>
            ...
            <ul class="lista-hanging">
                ...
                <ul class="lista-hanging">
                    ...
                    <li>12.6.&nbsp;&nbsp; "El TRABAJADOR se obliga, durante la vigencia de este contrato y por el lapso
                        de un (1) año posterior a su desvinculación, a no prestar servicios de supervisión o seguridad
                        de forma directa, ni a través de terceros, a ninguno de los clientes actuales de RIALTO PATROL
                        SRL. Asimismo, queda terminantemente prohibido desviar, captar o intentar captar a los clientes
                        de LA EMPRESA para beneficio propio o de empresas competidoras, constituyendo este hecho causal
                        de acciones civiles por daños y perjuicios."
                    </li>
                    <li>12.7.&nbsp;&nbsp; "Todo protocolo de seguridad, sistema de asignación de guardias, base de datos
                        de clientes, manuales y el diseño de los sistemas digitales de control de acceso (códigos QR)
                        son propiedad intelectual exclusiva de RIALTO PATROL SRL. El TRABAJADOR reconoce que el acceso a
                        esta información es estrictamente para fines operativos y su sustracción digital, copia o envío
                        a dispositivos no autorizados será considerado espionaje industrial, sujeto a proceso penal."
                    </li>
                </ul>
                ...
                <p>
                    <strong>DECIMA CUARTA. - (Responsabilidad por Negligencia y Daños) </strong> <br>
                   El TRABAJADOR, en su calidad de SUPERVISOR O ENCARGADO OPERATIVO, es civilmente responsable por los daños o perjuicios patrimoniales causados a LA EMPRESA o a los CLIENTES, derivados de su negligencia comprobada, dolo, inobservancia de los protocolos de seguridad o abandono de puesto. En caso de pérdida o deterioro de bienes de LA EMPRESA o del CLIENTE durante su turno, LA EMPRESA iniciará las investigaciones y acciones correspondientes.
                </p>
                <p>
                    <strong>DECIMA QUINTA. - (Uso de Herramientas Tecnológicas y Dispositivos) </strong> <br>
                ...
                <p>
                    ...
                    {{-- b) Las causales señaladas en el Art. 9 del Reglamento de la Ley General del Trabajo, las cuales incluyen, pero no se limitan a: <br>
                ...
                <p>
                    <strong>DECIMA OCTAVA. - (Devolución de Activos y Credenciales) </strong><br>
                    ...
                    conforme a los valores de inventario firmados por el TRABAJADOR al inicio de su gestión.
                </p>
                <p>
                    <strong>DECIMO NOVENA. - (De la Aceptación) </strong><br>
                    En plena conformidad a las cláusulas precedentes las partes intervinientes suscriben el presente Contrato De Trabajo a Conclusión de Servicio para el desempeño del cargo de <strong>SUPERVISOR O ENCARGADO OPERATIVO</strong>.
                </p>
                <p>
                    {{-- @dump($fecha) --}}
